...
class dashBoard(wx.Frame):
    ...
    def ShowDashBoard(self, data):
        ...
        self.SetToolTipString(text.tooltip)   
        ...
        def StaticText(txt, bold, coeff):
            ...
            st.SetToolTipString(text.tooltip)   
            return st
        ...
        self.ctrlIds = (wx.NewId(), wx.NewId())
        bmp = StaticBitmap(
            self, 
            self.ctrlIds[0],
            img,
        ...
        bmp.SetToolTipString(text.tooltip)   
...
class extDialog(wx.Frame):
    ...
    def ShowExtDialog(self, title):
        ...
        dgrows = len(labels)
        sizer = wx.FlexGridSizer(dgrows-1, 2, 5, 5)
