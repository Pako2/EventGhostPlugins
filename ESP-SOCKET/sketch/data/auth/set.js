...
var Modal;
var bulbState = 0;
var srcs=["/images/OFF34-72.png", "/images/ON34-72.png"];
var titles=["OFF", "ON"];
...
function listCONF(obj) {
  ...
  dlAnchorElem.setAttribute("download", "socket-settings.json");
  setBulb(obj.defstate);
...
{
  bulbState = state;
  document.getElementById("bulb").src = srcs[state];
  document.getElementById("bulb").title = titles[state];
}

function toggleBulb()
{
  setBulb(bulbState ? 0 : 1)
}
