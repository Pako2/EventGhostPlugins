    ...
    def Configure(
        ...
        def FillDevList(lst):
            ...
            for row in range(len(lst)):
                devListCtrl.InsertStringItem(row, lst[row][0])
                devListCtrl.SetStringItem(row, 1, lst[row][1])
        ...
        def FillSuffixList(lst):
            ...
            for row in range(len(lst)):
                suffixListCtrl.InsertStringItem(row, lst[row][0])
                suffixListCtrl.SetStringItem(row, 1, lst[row][1])
        w = 0
        ...
        def Validation():
            ...
            cnt = tmp.count(strng)
            if cnt > 1:
                suffixListCtrl.SetStringItem(self.oldSel, 0, "")
                suffText.ChangeValue("")
                flag = False
                MessageBox(
                    panel,
            ...
            cnt = tmp.count(strng)
            if cnt > 1:
                devListCtrl.SetStringItem(self.oldDevSel, 0, "")
                portCtrl.SetSelection(-1)
                flag2 = False
                MessageBox(
                    panel,
        ...
        def OnButtonAddDev(evt):
            ...
            devListCtrl.InsertStringItem(row, "")
            devListCtrl.SetStringItem(row, 1, "")
        ...
        def OnButtonAddEvent(evt):
            ...
            row = self.oldSel + 1
            suffixListCtrl.InsertStringItem(row, "")
            suffixListCtrl.SetStringItem(row, 1, "")
        ...
        def OnPortCtrl(evt):
            strng = evt.GetString()
            devListCtrl.SetStringItem(self.oldDevSel, 0, strng)
            Validation()
            evt.Skip()
        ...
        def OnSuffText(evt):
            strng = evt.GetString()
            suffixListCtrl.SetStringItem(self.oldSel, 0, strng)
            Validation()
            evt.Skip()
        ...
        def OnHumanText(evt):
            ...
            suffixListCtrl.SetStringItem(self.oldSel, 1, strng)
            Validation()
            evt.Skip()
        ...
        def OnPrefixCtrl(evt):
            ...
            devListCtrl.SetStringItem(self.oldDevSel, 1, strng)
            Validation()
            evt.Skip()
