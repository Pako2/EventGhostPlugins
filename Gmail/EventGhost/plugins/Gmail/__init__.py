...
class SendEmail(eg.ActionBase):
    ...
    def Configure(
        ...
        subjectLbl.SetToolTipString(text.tip0)
        subjectCtrl.SetToolTipString(text.tip0)
        toLbl=wx.StaticText(panel, -1, text.toLabel)
        toCtrl=wx.TextCtrl(panel,-1,To)
        toLbl.SetToolTipString(text.tip1)
        toCtrl.SetToolTipString(text.tip1)
        ccLbl=wx.StaticText(panel, -1, text.ccLabel)
        ccCtrl=wx.TextCtrl(panel,-1,Cc)
        ccLbl.SetToolTipString(text.tip2)
        ccCtrl.SetToolTipString(text.tip2)
        hdLbl=wx.StaticText(panel, -1, text.hdLabel)
        hdCtrl=wx.TextCtrl(panel,-1,Hidden)
        hdLbl.SetToolTipString(text.tip3)
        hdCtrl.SetToolTipString(text.tip3)
        ...
        textLbl.SetToolTipString(text.tip4)
        outTextCtrl.SetToolTipString(text.tip4)        
        ...
        attchLbl.SetToolTipString(text.tip5)
        sfLbl=wx.StaticText(panel, -1, text.sfLabel)
        sfCtrl=wx.TextCtrl(panel, -1, suffix)
        sfLbl.SetToolTipString(text.tip6)
        sfCtrl.SetToolTipString(text.tip6)
        ...
        panel.dialog.buttonRow.testButton.SetToolTipString(text.tip7)
