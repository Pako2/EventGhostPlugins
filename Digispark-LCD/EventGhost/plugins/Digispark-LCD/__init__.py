...
class Digispark_LCD(eg.PluginBase):
    ...
    def Configure(
        ...
        self.bitmaps = (
             wx.BitmapFromImage(wx.ImageFromStream(stream_0)),
    ...
    def dataToXml(self, data, xmlpath, filename):
        ...
        commentNode1 = dom.createComment(self.plugin.text.xmlComment1)
        dom.insertBefore(commentNode1, root)
        commentNode2 = dom.createComment(self.plugin.text.xmlComment2 % str(dt.now())[:19])
